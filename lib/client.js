...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  if (input.parts || args === null) {
    ...
    name = "int:" + input.$name;
    message = self.wsdl.objectToDocumentXML(name, args, "tmp", input.targetNamespace, (input.$type || input.$lookupType));
    message = message.replace("xmlns:tmp=\"http://interfaces.webservice.rocket.cmsoftware.com.br\"", "");
    message = message.replace(/tmp\:/g, "");
  }
  xml = "<soap:Envelope " +
    xmlnsSoap + " " +
    "xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" " +
    encoding +
    "xmlns:int=\"http://interfaces.webservice.rocket.cmsoftware.com.br\"" + '>' +
